...
def child(pid, cmd, argss):  
   ...
   #deal with pipes --------------------------------------------------
   if "<" in argss:
    os.system(cmd) #functionality not yet implemented for redirect input
   elif "sleep" in argss:
    os.system(cmd) #functionality not yet implemented for background process
   elif "|" in argss: 
    #run with os.system() for functionality
    os.system(cmd)
    #attempt to run with pipe & fork call
    stp = argss.index("|")
    #print (stp)
